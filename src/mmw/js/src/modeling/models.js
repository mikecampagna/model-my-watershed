...
var ProjectModel = Backbone.Model.extend({
    ...
    defaults: {
        ...
        subbasin_mapshed_job_uuid: null,   // (GWLF-E) The id of a successful subbasin mapshed job
    ...
    getGisData: function() {
        ...
        switch(App.currentProject.get('model_package')) {
            ...
            case utils.GWLFE:
                ...
                var modificationsCollection = self.get('modifications'),
                    modifications = modificationsCollection.map(function(mod) {
                        return mod.get('output');
                    });
